...
# input args
R_VERSION=${1:-4.0.2}
R_INSTALL=${2:-/usr/local/Frameworks}
R_LINK_DIR=${3:-/usr/local/bin}
R_SRC_ROOT=${4:-/usr/local/src/R}
R_BUILD_NAME=${5:-build-accelerate-framework}
# download R
R_TAR=
...
sudo make install
RFW_BIN=$R_INSTALL/R.framework/Resources/bin
R_BIN=$RFW_BIN/R
RS_BIN=$RFW_BIN/RScript
R_LINK=$R_LINK_DIR/R
